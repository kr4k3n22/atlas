...
function loadSettings() {
    ...
    try {
        ...
        return {
            ...defaultSettings,
            ...parsed,
            highRiskThreshold: typeof parsed.highRiskThreshold === "number" ? parsed.highRiskThreshold : defaultSettings.highRiskThreshold
        };
    } catch  {
...
function SettingsProvider({ children }) {
    _s();
    const [settings, setSettingsState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultSettings"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsProvider.useEffect": ()=>{
            const loaded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadSettings"])();
            setSettingsState(loaded);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTheme"])(loaded.theme);
            // if system theme, react to OS changes
            const mq = window.matchMedia ? window.matchMedia("(prefers-color-scheme: dark)") : null;
            const onChange = {
                "SettingsProvider.useEffect.onChange": ()=>{
                    const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadSettings"])();
                    if (s.theme === "system") (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTheme"])("system");
                }
            }["SettingsProvider.useEffect.onChange"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsProvider.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveSettings"])(settings);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTheme"])(settings.theme);
        }
    }["SettingsProvider.useEffect"], [
        settings
    ]);
    const api = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SettingsProvider.useMemo[api]": ()=>{
            return {
                settings,
                setSettings: ({
                    "SettingsProvider.useMemo[api]": (next)=>setSettingsState(next)
                })["SettingsProvider.useMemo[api]"],
                patchSettings: ({
                    "SettingsProvider.useMemo[api]": (patch)=>setSettingsState({
                            "SettingsProvider.useMemo[api]": (cur)=>({
                                    ...cur,
                                    ...patch
                                })
                        }["SettingsProvider.useMemo[api]"])
                ...
                resetSettings: ({
                    "SettingsProvider.useMemo[api]": ()=>setSettingsState(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultSettings"])
                })["SettingsProvider.useMemo[api]"]
            };
        }
    }["SettingsProvider.useMemo[api]"], [
...
_s(SettingsProvider, "tKS6vG6A0KvKIUDpAg90f3yyP90=");
_c = SettingsProvider;
...
_s1(useUserSettings, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
...
//# sourceMappingURL=_ea6b2505._.js.map