  ...
  return (
    <div className="rounded-lg border border-amber-500/30 bg-gradient-to-b from-amber-500/10 to-transparent space-y-3 p-3 -mx-1">
      <div className="flex items-center gap-2">
        ...
        <span className="font-semibold text-amber-800 dark:text-amber-400">Request Under Review</span>
      </div>

      {escalation.case_id && !escalation.case_id.startsWith("evt_") && (
        <div className="flex items-center gap-2">
          <span className="text-[11px] text-muted-foreground">Reference ID:</span>
          <span className="inline-flex items-center rounded border border-amber-500/40 bg-amber-500/15 px-2 py-0.5 font-mono text-[11px] text-amber-900 dark:text-amber-300">
            {escalation.case_id}
          </span>
        </div>
      )}
          ...
          <div className="mx-auto w-full max-w-3xl px-4 pt-4">
            <div className="flex items-start gap-3 rounded-lg border border-amber-500/40 bg-amber-500/10 px-4 py-3 text-sm text-amber-800 dark:text-amber-400">
              ...
              <div className="flex-1 min-w-0">
                ...
                {escalation.case_id && !escalation.case_id.startsWith("evt_") && (
                  <span className="ml-2 inline-flex items-center rounded border border-amber-500/40 bg-amber-500/20 px-2 py-0.5 font-mono text-[11px] text-amber-900 dark:text-amber-300">
                ...
                {(escalation.risk_label || escalation.risk_score !== undefined) && (
                  <div className="mt-1.5 flex items-center gap-2 flex-wrap">
                    {escalation.risk_label && (
                      <span className="inline-flex items-center rounded px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider bg-amber-500/20 text-amber-900 dark:text-amber-300">
                        {escalation.risk_label}
                      </span>
                    )}
                    {escalation.risk_score !== undefined && (
              ...
              <button
                ...
                className="ml-auto shrink-0 text-amber-800/60 dark:text-amber-400/60 hover:text-amber-800 dark:hover:text-amber-400 text-base leading-none"
                aria-label="Dismiss"
              >
                <X className="w-4 h-4" />
              </button>
