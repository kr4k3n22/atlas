...
VALUES (
        ...
        'Alex declared unemployment after redundancy but lacks required documentation and the employer report is not received. Despite otherwise clear eligibility signals, imminent livelihood risk requires mandatory human escalation.',
        '{
...
VALUES (
        ...
        'Claimant''s fixed-term contract ended and a renewal was declined. Contribution history is insufficient to qualify for unemployment benefits. Clear statutory ineligibility requires denial.',
        '{
  ...
  "free_text": {
    "claimant_message": "My fixed-term contract ended and I was offered another contract, which I chose not to accept. I have insufficient contribution history. I am financially stable and not experiencing hardship.",
    "agent_chat_transcript_excerpt": "Fixed-term contract concluded. Renewal was offered and declined. Contribution history below statutory minimum threshold.",
    "caseworker_note": "Clear statutory ineligibility due to insufficient contribution history."
  },
  "harm_rights_signals": {
    "signal_level": "none",
    "signal_type": [],
...
VALUES (
        ...
        'Claimant appears potentially eligible but key elements cannot be confirmed. No harm/rights-impact signals. Case must remain in an automated review loop.',
        '{
  ...
  "free_text": {
    ...
    "agent_chat_transcript_excerpt": "IDV and residency verified. Claimant reports unemployment after voluntary resignation. Contribution status and recent earnings cannot be confirmed.",
    "caseworker_note": "Do not escalate. Route to chatbot for targeted clarification and document collection."
  },
  "harm_rights_signals": {
    "signal_level": "none",
    "signal_type": [],
    "signal_source": "system",
    "notes": "No indicators of livelihood risk or rights-impact. Remain in automated review loop."
  }
}'::jsonb
    ) ON CONFLICT (beneficiary_id) DO
UPDATE
